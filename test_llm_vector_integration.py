...
def test_llm_engine():
    ...
    try:
        ...
        if not model_info['model_available']:
            print("⚠️ No LLM model loaded - skipping model tests")
            return True
...
def test_api_endpoints():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"⚠️ LLM status endpoint returned {response.status_code}")
        ...
        if chat_response.status_code == 200:
            ...
            print(f"⚠️ LLM chat endpoint returned {chat_response.status_code}")
        ...
        if search_response.status_code == 200:
            ...
            print(f"⚠️ Vector search endpoint returned {search_response.status_code}")
        ...
        if stats_response.status_code == 200:
            ...
            print(f"⚠️ Vector stats endpoint returned {stats_response.status_code}")
...
def test_integration_workflow():
    ...
    try:
        ...
        if llm_engine.get_model_info()['model_available']:
            ...
            print("⚠️ No LLM model - skipping analysis generation")
