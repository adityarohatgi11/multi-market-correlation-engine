...
class EndToEndTester:
    ...
    def cleanup(self):
        ...
        try:
            ...
            print(f"⚠️  Error stopping agent coordinator: {e}")
    ...
    def generate_report(self):
        ...
        print(f"\n⏱️  Total test execution time: {total_duration:.2f} seconds")
    ...
    def run_all_tests(self):
        ...
        try:
            ...
            if not self.test_phase_3_agents():
                print("⚠️  Phase 3 issues - continuing with API tests")
            ...
            print(f"\n⏱️  Total end-to-end test duration: {overall_duration:.2f} seconds")
