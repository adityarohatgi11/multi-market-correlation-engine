        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if not llm_available:
                    st.warning("⚠️ LLM model not available. Some features will be limited.")
    ...
    def _render_correlation_insights(self):
        ...
        if symbols_for_corr:
            ...
            if len(symbols_list) <= 6:  # Reasonable limit for manual input
                ...
                st.warning("⚠️ Please enter 6 or fewer symbols for manual correlation input")
        ...
        with col4:
            if st.button("🗑️ Clear Database", type="secondary"):
                if st.session_state.get('confirm_clear', False):
                    ...
                    st.warning("⚠️ Click again to confirm clearing the database")
