...
print(" Volatility forecast returned empty result")
else:
print(" GARCH model fitting returned empty result")
...
print(" Network creation returned empty result")
